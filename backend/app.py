...
MODEL_PATH = r"C:\Users\Lenovo\Downloads\yt_ai_classifier_model_2.sav"
VECTORIZER_PATH = r"C:\Users\Lenovo\Downloads\tfidf_vectorizer.sav"
...
def summarize(counts):
    ...
    if g > b:
        return "Chat is largely positive — praise, hype, and excitement dominate."
    if b > g:
        return "Viewers are unhappy — complaints and criticism are common."
    return "Reactions are mixed — confusion, questions, and divided opinions."
